...
difficulty: 4
foad: []
topics: [inorganic, bornite, ferrate, stoichiometry, redox]
date: "2026-05-24"
description: ""
---
...
2. **冷门物种是苏联题的常客**——$[\mathrm{Li}(\mathrm{NH}_{3})_{4}]\mathrm{O}_{3}$（题 1）、$\mathrm{FeO}_{4}^{2-}/\mathrm{BaFeO}_{4}$（本题）、$\mathrm{K[{}^{129}ICl_{4}]}/\mathrm{XeCl}_{4}$（题 3）——平时读题多积累几类"反常"物种的颜色、溶解性与核化学来源是有效投资。
