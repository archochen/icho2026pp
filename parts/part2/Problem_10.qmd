...
<img src="images/c52587024bc6bc1084b6a1c4338992edfe524edc7b3a990b7c89ff5b7fc8da21.jpg" alt="image" style="zoom:50%;" />
...
>
> **Revision note:** Revised by Codex on 2026-05-18; Q10.1 was corrected against the arrows in the scheme, and a source-backed structure plate was added. Revised again on 2026-05-19: D was changed from open-chain ribose to the six-membered D-ribopyranose form, E was kept as D-ribofuranose, G was changed to propiolamide, and G' was changed first to acetyl cyanide and then to cyanoacetaldehyde. The original question text and figure were not changed.
>
...
>
> $$\boxed{\text{A = 2-aminooxazole; B = arabinose amino-oxazoline; C = 2,2'-anhydroarabinonucleoside; D = D-ribopyranose; E = D-ribofuranose; F = urea; G = propiolamide; G' = cyanoacetaldehyde; I = cytidine.}}$$
...
>
> **Revision note:** Revised by Codex on 2026-05-18; the Fischer projections were kept, but the loose wedge/dash wording was replaced with source-backed stereochemical structure images. Revised again on 2026-05-19: the PubChem wedge/dash images were replaced with online Fischer-projection images from Wikimedia Commons. The original question text was not changed.
>
...
>
> **Revision note:** Revised by Codex on 2026-05-19; added the short kinetic derivation that justifies replacing the product ratio by the rate-constant ratio for a racemic substrate, then expanded the algebra showing how the given rate constants reduce to the hyperbolic-tangent form. The original question text was not changed.
>
...
5. Consider some racemic solution of L-/D-isomers in water with a total concentration of $1\ \mathbf{M}$, where symmetry breaking (i.e. conversion of one isomer into another) occurs, resulting in overall chiral amplification of the system. **Depict** possible symmetry-breaking trajectories in a phase portrait of the system.
   ...
   <img src="images/0999913bdcae8aa357b971653b4a59617438a8d2cd82f9b94f1644d35327d49e.jpg" alt="image" style="zoom:50%;" />

> **Solution (Q5 — Symmetry-breaking phase portrait).**
>
> **Revision note:** Revised by Codex on 2026-05-19; added references for the Frank-type chiral symmetry-breaking phase portrait. The original question text and figure were not changed.
>
...
<img src="images/70d4f33706748fdd34b3bdc7af003be1c002e1301111077c08bc5744ca3e8788.jpg" alt="image" style="zoom: 67%;" />

<img src="images/59c359de8763e198caf67dcc2f2cda47313ee178513750538cc344b39a3a96b4.jpg" alt="image" style="zoom:67%;" />

<img src="images/ad98865ce78a371a799f4fc108fc87b58f6d2b7857cc6f7a7ca24eaa72e83a59.jpg" alt="image" style="zoom: 67%;" />

9. **Draw** the structure of **K**.

> **Solution (Q9 — Structure of K).**
>
> **Revision note:** Revised by Codex on 2026-05-18; K was corrected from an amino-acid thioester to the N-acetyl α-aminonitrile required by the drawn amidine intermediate. Representative stereochemical images were added from PubChem. The original question text and figures were not changed.
>
...
<img src="images/5928dbb91cea5b5e1ec814924766b48abc6fe9527645254aba9c2699cf4b9876.jpg" alt="image" style="zoom:67%;" />

<img src="images/4cac7e090a9187ec1c90974639dab6effc0cf678e8740be3c0d017cabd2fda49.jpg" alt="image" style="zoom: 67%;" />
...
>
> **Revision note:** Revised by Codex on 2026-05-18 and updated on 2026-05-19; the Pro residue was corrected to the N-terminal secondary amine, and the HAT-active groups were separated from merely supporting hydrogen-bond sites. The mechanistic wording was tightened: because the scheme shows $\mathrm{[LL-H]^+}$, the catalyst step is best treated as LL-mediated proton transfer/formal 1,3-H shift rather than literal neutral-radical HAT. The original question structure was not changed.
>
...
>
> **Revision note:** Revised by Codex on 2026-05-18 and updated on 2026-05-19; M was corrected to a PM-derived ketimine rather than an aldimine, and the carboxylate/Schiff-base connectivities were tightened. The N assignment was refined from a neutral radical-style HAT drawing to a deprotonated quinonoid/azaallyl intermediate, because the question scheme explicitly forms $\mathrm{[LL-H]^+}$. Source-article structure images were added below. Exact standalone database images labelled M-N-O were not found, so the images are taken from the Yu et al. source schemes and mapped explicitly to the problem labels. The original question figure was not changed.
>
...
>
> **Revision note:** Revised by Codex on 2026-05-18 and updated on 2026-05-19; π-stacking was restored because the cited transition-state model involves stacking between the pyridoxal aldimine and the Pro-Val catalyst, not between alanine and an aromatic alanine substituent. A source figure and more detailed DFT-based justification were added. The original question options were not changed.
>
...
<img src="images/88407ac6d99112de96a38b8df8989e5a6b18e78b50f617cf85d85ffb7998c553.jpg" alt="image" style="zoom: 67%;" />

<img src="images/368b48d8a667bb527cfa59bd156a94bd6291e2799bb62c314403a8e0deeaf238.jpg" alt="image" style="zoom:67%;" />
...
>
> **Revision note:** Revised by Codex on 2026-05-18; the answer was changed from "near $\varphi_1$ / just below $\varphi_2$" to the actual maximum separation of the two plotted branches. The original figure was not changed.
>
...
>
> **Revision note:** Revised by Codex on 2026-05-18; the high-flow regime was split between the constructive and destructive plots instead of treating both as simple total wash-out. The original question and figure were not changed.
>
