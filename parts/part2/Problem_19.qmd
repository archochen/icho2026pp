...
Asymmetric synthesis has attracted significant attention in recent years thanks to advances in asymmetric catalysis. Nevertheless, the transformation of stereocenters in readily available chiral substrates remains an efficient approach to enantioselective total synthesis, commonly referred to as the “chiral pool” strategy. Various monosaccharides serve as convenient starting materials in natural product synthesis. For example, in 1985, the first synthesis of compound **X** from L-sorbose derivative **A** was published.
...
近年来，随着不对称催化的发展，不对称合成备受关注。然而，利用易得的手性底物中已有立体中心进行转化，仍是对映选择性全合成的高效路径——通常称为“手性池 (chiral pool) 策略”。各类单糖是天然产物合成中便利的起始原料。1985 年，首次报道了以L–山梨糖衍生物A为原料合成化合物X的路线。
