...
> **Solution (QN — identification of the Wilkinson precursors).**
...
>
> **Revision note:** Revised by Codex on 2026-05-18; the former diphenylalkene assignment was incompatible with the printed mass spectrum because the proposed "m/z 119" diphenylmethyl cation would actually have m/z 167. A later tert-butylethylbenzene assignment was also rejected because its reference EI spectrum has a dominant $m/z=147$ peak, which is not present as a major feature in the question spectrum. Mechanistic justification for the $m/z=41$ side-chain ion and for the two aromatic fragment ions was added after follow-up review. The original question and spectrum were not changed.
>
> The printed spectrum has a molecular-ion region at $m/z\approx 162$, and the diagnostic fragments match **1-ethyl-4-isobutylbenzene**. The three intense cations are:
>
> $$m/z=41:\quad [\mathrm{C_3H_5}]^+,$$
> an allylic hydrocarbon cation, often drawn as
> $$\mathrm{CH_2{=}CH{-}CH_2^+ \leftrightarrow CH_2^+{-}CH{=}CH_2}.$$
>
> The neutral product does not contain a pre-existing allyl group; this is an EI-MS rearrangement/dehydrogenation fragment. A reasonable pathway is complementary charge retention during cleavage of the isobutyl side chain:
> $$[\mathrm{M}]^{+\bullet}\rightarrow \mathrm{p\text{-}Et{-}C_6H_4CH_2^\bullet}+ \mathrm{(CH_3)_2CH^+}$$
> followed by loss of $\mathrm{H_2}$ from the $\mathrm{C_3H_7^+}$ ion:
> $$\mathrm{C_3H_7^+}\rightarrow \mathrm{C_3H_5^+}+\mathrm{H_2}.$$
>
> $$m/z=91:\quad [\mathrm{C_7H_7}]^+,$$
> the benzyl/tropylium cation, drawn most cleanly as the aromatic cycloheptatrienyl cation.
>
> $$m/z=119:\quad [\mathrm{C_9H_{11}}]^+,$$
> an ethyl-substituted benzyl/tropylium-type cation. One acceptable drawing is the $p$-ethylbenzyl cation, $\mathrm{Et{-}C_6H_4{-}CH_2^+}$, formed by cleavage of the isobutyl side chain as loss of $\mathrm{\cdot C_3H_7}$; it can rearrange to the ethyl-tropylium form under EI-MS conditions.
>
> This ion also explains the formation of $m/z=91$ by secondary loss of ethene:
> $$\mathrm{C_9H_{11}^+}\rightarrow \mathrm{C_7H_7^+}+\mathrm{C_2H_4}.$$
>
> The two aromatic-ring fragments mentioned in the question are therefore $m/z=91$ and $m/z=119$. This does **not** mean that the neutral product contains two aromatic rings. It means the two fragment cations are different aromatic-ring ions: $\mathrm{C_7H_7^+}$ is tropylium, while $\mathrm{C_9H_{11}^+}$ is an ethylbenzyl/ethyl-tropylium-type aromatic cation.

4. **Draw** the structure of the **product**.

> **Solution (Q4 — hydrogenation product).**
>
> **Revision note:** Revised by Codex on 2026-05-18; the product was corrected to match the spectrum and the "maximum one plane of symmetry" clue. Updated again after external spectrum checking: the tert-butyl isomer would show a strong $m/z=147$ peak, so the side chain must be isobutyl rather than tert-butyl.
>
> The product is:
> $$\boxed{\mathrm{p\text{-}Et{-}C_6H_4{-}CH_2CH(CH_3)_2}}$$
> i.e. **1-ethyl-4-isobutylbenzene**.
>
> Its formula is $\mathrm{C_{12}H_{18}}$ and $M_r\approx162.27$, matching the high-mass peak cluster near $m/z=162$ in the spectrum. The para relationship of the ethyl and isobutyl groups gives the idealized product at most one mirror plane. Under EI-MS, cleavage of the isobutyl side chain gives $\mathrm{C_9H_{11}^+}$ at $m/z=119$; further rearrangement/fragmentation gives $\mathrm{C_7H_7^+}$ at $m/z=91$, and the hydrocarbon side chain gives $\mathrm{C_3H_5^+}$ at $m/z=41$.
